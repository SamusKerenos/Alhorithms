...
namespace LINQTask
{
	public class Task_05
	{
		...
		public IEnumerable<Customer> GetCustomersWithMoreThenFiveOrders()
		{
			...
			return Source.Customers.Where(c => c.Orders.Any(o => o.Quantity > 5));
		}
		...
		{
			//throw new NotImplementedException();
			return Source.Customers.Select(i => i.Orders.Select(o => new CustomerWithProduct
			{
